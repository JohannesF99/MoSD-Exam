...
.. remove NaN rows
.. export the dataset for every country in the directory `./data/out/` (so we have even an additional thing to analyse besides the main research question)
...
. all developing happends now in the _data_analysis.ipynb_ notebook
